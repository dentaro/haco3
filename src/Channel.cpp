...
bool Channel::note(uint8_t channelno, uint8_t toneTickNo, uint8_t _patternNo)
{
    ...
    setChannelVolume(channelno, this->notedata[channelno][toneTickNo%32].volume*32);//BGM
...
//     size_t targetChNo = channelno;//patterns[_patternNo][channelno];
//     size_t index = (tick + _buffAreaNo * 32) % TONE_NUM;

//     // デバッグ出力
//     // Serial.print("targetChNo: ");
//     // Serial.print(targetChNo);
//     // Serial.print(", tick: ");
//     // Serial.print(tick);
//     // Serial.print(", _buffAreaNo: ");
//     // Serial.print(_buffAreaNo);
//     // Serial.print(", TONE_NUM: ");
//     // Serial.print(TONE_NUM);
//     // Serial.print(", index: ");
//     // Serial.println(index);

//     // targetChNo の範囲を確認0~7
//     if (targetChNo > CHANNEL_NUM) {
//         Serial.println("Error: targetChNo is out of range!");
//         return false;
//     }

//     // index の範囲を確認
//     if (index >= TONE_NUM) {
//         Serial.println("Error: index is out of range!");
//         return false;
//     }

//     // hz の値を確認
//     float hz = this->notedata[targetChNo][index].hz;
//     // Serial.print("hz: ");
//     // Serial.println(hz);
...
//         targetChNo, 
//         true,
//         _tone_wav[this->notedata[targetChNo][index].instrument],
//         16,
//         false
//     );
