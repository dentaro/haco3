...
void LovyanGFX_DentaroUI::flickSetup(LGFX* _lcd, LGFX_Sprite& _layoutSprite,
  ...
  createBtns( 0,    18, 240, 30,  1, 1, MULTI_EVENT );//BTN_1
...
//  setFlickPanel(0, 1, "臨兵闘者皆陣列前行");
  ...
  createBtns( 0,   48,  48, 192, 1, 4, MULTI_EVENT );//BTN_3
  createBtns( 192, 48,  48, 192, 1, 4, MULTI_EVENT );//BTN_4
...
//   // uiID++;
// // }else if(uiID>=127){
// //   uiBoxes2.push_back(*new UiContainer);
// //   uiBoxes_num++;
// //   uiID++;
// //
// // }
...
void LovyanGFX_DentaroUI::createLayout( int _x, int _y, int _w, int _h, LGFX_Sprite& _layoutSprite, int _eventNo = MULTI_EVENT){
  // uiBoxes.push_back(*new UiContainer);
    ...
    _layoutSprite.setPsram(USE_PSRAM );
...
// void LovyanGFX_DentaroUI::drawPngImg(LovyanGFX& _lcd, double png__x, double png__y, int png__w, int png_h){
...
void LovyanGFX_DentaroUI::drawMaps(LovyanGFX& _lcd, double _walkLatPos, double _walkLonPos, int _tileZoom)
{
//
//   for(int objId = 0; objId < BUF_PNG_NUM; objId++)
//     {
